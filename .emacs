...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (racket-mode tide flycheck-ocaml reason-mode utop tuareg evil-surround sml-mode elpy lua-mode base16-theme company flycheck markdown-mode nyan-mode evil)))
 '(pdf-view-midnight-colors (quote ("#6a737d" . "#fffbdd")))
 '(safe-local-variable-values (quote ((indent-tabs-mode . nill) (indent-tabs-mode nil))))
 '(scroll-bar-mode nil)
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#ffffff" :foreground "#6c696e" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "MONO" :family "Cousine")))))
